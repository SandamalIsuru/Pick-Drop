...
if (isset($_POST['searchbar']))
{
    ...
    $userRegNo = $_POST['searchbar']; 

}else{
	$userRegNo = $_GET['userRegID'];
}
...
$con = new database();
$y = $con->getTableDetailsWithColName("user","reg_no",$userRegNo);
			  ...
			  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
                        ...
                        <li><i class="#"></i> <?php echo $userRegNo ?></li>					  	
					</ol>
				</div>
			</div>
			...
			?>
            	<div class="col-lg-4 image">
                        ...
                        <div class="col-lg-8 userDetail">
                            	...
                            	<div class="jumbotron detail">
                                	<div class="row">
                                        ...
                                        <form action="php/update_user.php?userID=<?php echo $row1[0] ?>&userRegID=<?php echo $userRegNo ?>" method="post" class="act">
                                    	
                                        	<label class="des">Full Name :</label><input name="name" type="text" class="del" value="<?php echo $row1[1] ?>"><br>
                                            <label class="des">Gender :</label><input name="gender" type="text" class="del" value="<?php echo $row1[2] ?>"><br>
                                            <label class="des">Registration Number :</label><input name="regNo" type="text" class="del" value="<?php echo $row1[3] ?>"><br>
                                            <label class="des">Email :</label><input name="email" type="text" class="del" value="<?php echo $row1[4] ?>"><br>
                                            <label class="des">Mobile :</label><input type="text" name="mobile" class="del" value="<?php echo $row1[5] ?>"><br><br>
                                            
                                            <button type="submit" class="btn btn-danger done"><i class="fa fa-check-circle-o"></i> Done</button>
                                          <a class="btn btn-danger cancel" href="userDetails.php?userRegID=<?php echo $userRegNo ?>"><i class="icon_close_alt2"></i> Cancel</a>
                                          </form>
                                            <?php
						...
						<div class="col-lg-4 image">
                            ...
                            <a class="btn btn-success" id="updateUser" href="userDetails.php?userRegID=<?php echo $userRegNo ?>&userID=<?php echo $row1[0] ?>"><i class="fa fa-pencil-square-o"></i> Update</a>
                            	...
                            	<div class="jumbotron detail">
                                	<div class="row">
                                    	<header class="info">
                                            ...
                                            <label class="des">Gender :</label><input type="text" readonly class="del" value="<?php echo $row1[2] ?>"><br>
                                            <label class="des">Registration Number :</label><input type="text" readonly class="del" value="<?php echo $row1[3] ?>"><br>
                                            <label class="des">Email :</label><input type="text" readonly class="del" value="<?php echo $row1[4] ?>"><br>
                                            <label class="des">Mobile :</label><input type="text" readonly class="del" value="<?php echo $row1[5] ?>">
                        ...
                        <div class="confirm-box">
                                ...
                                <div class="confirm-body">
                                    ...
                                    <form role="form" action="php/delete_user.php?userID=<?php echo $row1[0] ?>" method="post" class="registration-form1">
