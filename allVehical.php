          ...
          <section class="wrapper">            
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="top-big-link">
                         <a class="btn btn-link-1 launch-modal" href="#" data-modal-id="modal-register">New Vehical</a>
                    </div>
                </div>
           
            
                <div class="col-lg-6">
                    <form class="navbar-form" action="vehicleDetails.php" method="post">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                    <a class="thumbnail" href="vehicleDetails.php?vehicleNo=<?php echo $row[3] ?>" onclick="post">
                        <img class="img-responsive" src="img/<?php echo $row[11] ?>" alt="">
                        <h4><strong><?php echo $row[3] ?></strong></h4>
                    </a>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    ...
                                    <h3 class="modal-title" id="modal-register-label">Add New Vehical</h3>
                                    <h4>Fill in the form below to add new Vehical:</h4>
                                </div>
