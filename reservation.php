...
$con = new database();
$y = $con->getReservationDetails("reservation","user",$userID);
			  ...
			  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
                        ...
                        <li><i class="#"></i><a href="reservationDetail.php"> Unapprove Reservation</a></li>
						<li><i class="#"></i> Reservation Details</li>
            ...
            <?php
                ...
                <div class="col-lg-8 userDetail">
                            	...
                            	<div class="jumbotron detail">
                                	<div class="row">
                                    	<header class="info">
                                        	...
                                        	<label class="des">Applicant's Name :</label><input type="text" readonly class="del" value="<?php echo $row1[1] ?>"><br>
                                            <label class="des">Designation :</label><input type="text" readonly class="del" value="<?php echo $row1[10] ?>"><br>
                                            <label class="des">Description :</label><input type="text" readonly class="del" value="<?php echo $row1[3] ?>"><br>
                                            <label class="des">Require Date :</label><input type="text" readonly class="del" value="<?php echo $row1[5] ?>"><br>
                                            <label class="des">Start Time :</label><input type="text" readonly class="del" value="<?php echo $row1[6] ?>"><br>
                                             <label class="des">End Time :</label><input type="text" readonly class="del" value="<?php echo $row1[7] ?>"><br>
                                            <label class="des">Purpose for use of visited :</label><input type="text" readonly class="del" value="<?php echo $row1[8] ?>"><br>
                                            <label class="des">Place/s to be Visited :</label><input type="text" readonly class="del" value="<?php echo $row1[9] ?>"><br>
                                            <label class="des">Number of Person to Visited :</label><input type="text" readonly class="del" value="<?php echo $row1[11] ?>"><br>
                                            <label class="des">Received Date :</label><input type="text" readonly class="del" value="<?php echo $row1[2] ?>"><br>
						...
						<div class="col-lg-4 image">
                            ...
                            <a class="btn btn-success" id="updateUser" href="addReservation.php?reservationID=<?php echo $row1[0] ?>"><i class="fa fa-pencil-square-o"></i> Accept</a>
                            <a class="btn btn-danger launch-modal1" id="deleteUser" href="#" data-modal-id="modal-register1"><i class="fa fa-trash-o"></i> Ignore</a>
						</div>
                        ...
                        <div class="confirm-box">
                                ...
                                <div class="confirm-body">
                                    ...
                                    <form role="form" action="php/delete_request.php?reservationID=<?php echo $row1[0] ?>" method="post" class="registration-form1">
                                        
                                        <h3>Are you sure you want to Ignore!</h3>
                                        <div class="buttons">
