...
<html lang="en">
  <head>
    ...
    <title>PickANDDrop members</title>
      ...
      <section id="main-content">
          <section class="wrapper">            
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <form class="navbar-form" action="userDetails.php" method="post">
                      ...
                      <section class="panel">
                          ...
                          <table class="table table-striped table-advance table-hover">
                           <tbody>
                              ...
                              <tr contenteditable="false" >
                                 <td data-href="userDetails.php?userRegID=<?php echo $row[3] ?>"><?php echo $row[1] ?></td>
                                 <td data-href="userDetails.php?userRegID=<?php echo $row[3] ?>"><?php echo $row[2] ?></td>
                                 <td data-href="userDetails.php?userRegID=<?php echo $row[3] ?>"><?php echo $row[3] ?></td>
                                 <td data-href="userDetails.php?userRegID=<?php echo $row[3] ?>"><?php echo $row[4] ?></td>
                                 <td data-href="userDetails.php?userRegID=<?php echo $row[3] ?>"><?php echo $row[5] ?></td>
                                 <td>
                                  <div class="btn-group">
                        ...
                        <div class="confirm-box">
                                ...
                                <div class="confirm-body">
                                    ...
                                    <form role="form" action="php/delete_user.php?userID=<?php echo $row[0] ?>" method="post" class="registration-form1">
