...
<html lang="en">
          ...
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12 col-md-12 col-xs-12">
					<h3 class="page-header"><i class="fa fa-laptop"></i> Accept Request</h3>
					...
					<ol class="breadcrumb">
                        ...
                        <li><i class=""></i> Accept Request</li>
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="form-validate form-horizontal" id="feedback_form" method="post" action="php/addReservation.php?reservationID=<?php echo $reservationID ?>">
                                  
                                      <div class="form-group ">
                                      	  <label for="curl" class="control-label col-lg-2">Driver</label>
                                          <div class="col-lg-10">
                                              <select class="form-control input-lg m-bot15" name="driver" id="dri">
                                              <?php
							  					foreach($z as $row) {
                                      ...
                                      <div class="form-group ">
                                      	  <label for="curl" class="control-label col-lg-2">Vehicle</label>
                                          <div class="col-lg-7">
                                              <select class="form-control input-lg m-bot15" name="vehicle" id="vehi" onChange="myFunction()">
                                              ...
                                              <?php
							 				  ...
							 				  ?>
                                 <option value="<?php echo $row[11]; ?> "><?php echo $row[3]; ?></option>
                                          ...
                                          <div class="col-lg-3">
                                          	<img class="img-responsive" id="my_image" src="" alt="">
                                          </div>
                                      </div>
  ...
  <!-- container section start -->
	...
	function myFunction() {
		var img = $('#vehi').val();
		$('#my_image').attr('src','img/'+img);
		document.getElementById('selected_text').value=$("#vehi option:selected").text();
	}
